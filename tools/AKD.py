...
class TrainManager(object):
    def __init__(self, max_temprature, phase, student, teacher=None, train_loader=None, test_loader=None,
                 train_config={}):
...
if __name__ == "__main__":
    ...
    print('#' * 90)
    student_trainer_p1 = TrainManager(args.max_temperature, 1, student_model, teacher=teacher_model,
                                      train_loader=train_loader, test_loader=test_loader,
