...
def add_distillation_cfg(cfg):
    ...
    cfg.KD = CN()
    cfg.KD.TYPE = "KD" # ("DKD", "ReviewKD")
    cfg.KD.INIT_TEMPERATURE = 3.0
    cfg.KD.MIN_TEMPERATURE = 1.0
    cfg.KD.MAX_TEMPERATURE = 4.0
...
def add_teacher_cfg(cfg):
    ...
    cfg.TEACHER.SOLVER.MAX_ITER = 30000
    ...
    cfg.TEACHER.SOLVER.STEPS = (20000,)
    ...
    cfg.TEACHER.SOLVER.IMS_PER_BATCH = 2
    ...
    cfg.TEACHER.CUDNN_BENCHMARK = True
